...
import {CursorType, ScreenType} from '@0fan/designable-core'
import {
    useCursor,
    useHistory,
    useScreen,
    usePrefix,
    useWorkbench, useCssInJs,
} from '../../hooks'
import {IconWidget} from '../IconWidget'
import cls from 'classnames'
// import './styles.less'
import {genDesignerToolsWidgetStyle} from "./styles";
...
export const DesignerToolsWidget: React.FC<IDesignerToolsWidgetProps> =
    observer((props) => {
        ...
        const {hashId, wrapSSR} = useCssInJs({prefix, styleFun: genDesignerToolsWidgetStyle})
        ...
        return wrapSSR(
            <div style={props.style} className={cls(prefix, props.className, hashId)}>
