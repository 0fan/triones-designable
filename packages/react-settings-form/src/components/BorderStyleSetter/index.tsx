...
import {useCssInJs, usePrefix} from '@0fan/designable-react'
...
const BorderStyleOptions = (hashId?: string) => {
    return [
        {
            label: 'None',
            value: 'none',
        ...
        {
            label: <span className={cls("border-style-solid-line", hashId)}/>,
            value: 'solid',
        },
        {
            label: <span className={cls("border-style-dashed-line", hashId)}/>,
            value: 'dashed',
        },
        {
            label: <span className={cls("border-style-dotted-line", hashId)}/>,
            value: 'dotted',
        },
    ]
}
...
export const BorderStyleSetter: React.FC<IBorderStyleSetterProps> = observer(
    ({className, style}) => {
        ...
        const {hashId} = useCssInJs({prefix, styleFun: genBorderStyleSetterStyle})

        return (
            <FoldItem label={field.title}>
                <FoldItem.Extra>
                    <div className={cls(prefix, className, hashId)} style={style}>
                        <div className={cls(prefix + '-position', hashId)}>
                            <PositionInput
                        ...
                        <div className={cls(prefix + '-input', hashId)}>
                                ...
                                return (
                                    <Fragment key={key}>
                                        <Field
                                            ...
                                            dataSource={BorderStyleOptions(hashId)}
