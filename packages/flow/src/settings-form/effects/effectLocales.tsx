...
import { TreeNode, GlobalRegistry } from '@0fan/designable-core'
import { isStr } from '@0fan/designable-shared'
import { IconWidget } from '@0fan/designable-react'
...
export const effectLocales = (node: TreeNode) => {
    onFieldReact('*', (field) => {
